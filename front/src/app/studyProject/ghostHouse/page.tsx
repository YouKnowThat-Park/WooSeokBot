...
const page = () => {
  return (
    <>
      ...
      <div className="w-[970px] h-full mt-10 p-6 border border-neutral-300 dark:text-[#fbfbfb]  dark:bg-[#2e2e2e] dark:border-neutral-700">
        <ProjectDescription
          title="팀 프로젝트 과제"
          paragraphs={[
      ...
      <div className="w-[1000px]">
        <NextStudyProjectsSlider excludeId="GhostHouse" />
      </div>
    </>
  );
};
