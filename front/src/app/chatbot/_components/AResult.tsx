...
const AResult = () => {
  return (
    <div className="w-[970px] h-full mt-[400px] mb-[84px] bg-[#FBFBFB] rounded-tl-[45px] overflow-hidden px-6">
      ...
      <div className="flex  w-full h-[100px] mt-10 justify-between gap-2"></div>
